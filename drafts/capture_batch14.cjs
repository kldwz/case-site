...
const targets = [
  ['storyshort',     ['https://storyshort.ai', 'https://www.storyshort.ai']],
  ['campfire',       ['https://campfire.ai', 'https://www.campfire.ai']],
  ['sleek-design',   ['https://sleek.design', 'https://www.sleek.design']],
  ['bland-ai',       ['https://www.bland.ai', 'https://bland.ai']],
  ['rork',           ['https://rork.app', 'https://www.rork.app', 'https://rork.com']],
  ['develop-health', ['https://www.develophealth.ai', 'https://develophealth.ai']],
  ['model-ml',       ['https://www.modelml.com', 'https://modelml.com']],
];
    ...
    for (const url of urls) {
      for (let attempt = 1; attempt <= 6 && !ok; attempt++) {
        ...
        try {
          ...
          if (sz < 20000) { fs.unlinkSync(outPath); throw new Error('too small'); }
          ok = true;
        } catch (e) {
