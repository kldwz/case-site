...
const targets = [
  ['thinking-machines', ['https://www.thinkingmachines.ai', 'https://thinkingmachines.ai']],
  ['zania', ['https://www.zania.ai', 'https://zania.ai']],
  ['durable', ['https://www.durable.co', 'https://durable.co']],
];
