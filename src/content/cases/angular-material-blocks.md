...
为 Angular 开发者提供快速 UI 开发的预构建块、精美模板和强大的 CLI 工具。

## 怎么赚的钱

通过销售产品许可或订阅，具体定价模式未披露。近30天营收$237，近12个月营收$4,088，累计营收$9,422。

## 流量从哪来

主要来自 ui.angular-material.dev 主站，以及 angular-ui.com（贡献25%营收）、angular-material.dev（14%）和 themes.angular-material.dev（5%）等子站点。

## 站长是谁

Dharmen Shah，来自印度，X平台有654名粉丝。

## 这个案例能学到什么

展示如何通过工具链整合（模板+CLI）提升开发者工作流效率，以及通过域名矩阵策略分散流量风险。目前产品挂牌出售中。

## 来源与数据

- TrustMRR 原始页：`https://trustmrr.com/startup/angular-material-blocks`
- 营收由 Paddle API 验证，非自报；最后同步 2026-09-15T10:29:59.211Z。
- 官网：`https://ui.angular-material.dev/`

## 一句话总结

> 一个整合模板资源和 CLI 工具的 Angular 开发套件，采用多域名策略，目前处于出售状态。
