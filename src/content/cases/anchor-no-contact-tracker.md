...
移动端应用，主要功能包括无联系天数追踪、AI情感支持教练、每日签到、模拟给前任发消息的情绪宣泄工具，以及记录分手原因的红旗提醒功能。

## 怎么赚的钱

免费下载+应用内订阅，通过Superwall处理支付，当前MRR为75美元。

## 流量从哪来

未官方披露，创始人Timi在X平台有820名关注者。
...
验证了细分情感健康领域的付费需求可能性，展示如何将心理学概念（如无接触原则）转化为具体功能。产品设计亮点在于同时满足理性记录（红旗功能）和情感宣泄（模拟消息）的双重需求。

## 来源与数据

- TrustMRR 原始页：`https://trustmrr.com/startup/anchor-no-contact-tracker`
- 营收由 Superwall API 验证，非自报；最后同步 2026-09-15T10:52:19.483Z。
- 官网：`https://anchor-nocontactracker.netlify.app/`

## 一句话总结

> 针对分手恢复期的小众工具，验证了情感健康类应用的微付费可行性。
