...
# Aishorts：是一款帮助创作者快速生成动态短视频和逼真动画的 AI 工具，无需手动编辑。

## 产品是什么

一款 AI 驱动的短视频生成工具，可自动创建动态场景和逼真动画，主要面向内容创作者。

## 怎么赚的钱

通过订阅模式收费，当前 MRR 为 11 美元，近 30 天营收 233 美元，累计营收 209,582 美元。
...
展示了如何通过解决特定用户群体（内容创作者）的具体痛点（手动编辑耗时）来构建小众 SaaS 产品，即使订阅用户数量不多也能实现可持续收入。

## 来源与数据

- TrustMRR 原始页：`https://trustmrr.com/startup/aishorts`
- 营收由 Stripe API 验证，非自报；最后同步 2026-09-15T09:53:22.106Z。
- 官网：`https://aishorts.store/`

## 一句话总结

> 小众 AI 视频工具通过解决创作者特定需求实现长期盈利。
