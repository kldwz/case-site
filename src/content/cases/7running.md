...
# 7Running：AI生成跑步训练计划的法国SaaS产品

## 产品是什么

通过AI将用户跑步数据转化为个性化动态训练计划的在线工具，提供免费基础诊断和付费订阅服务

## 怎么赚的钱

采用Freemium模式：免费版提供基础功能，付费版（月付€13/年付€107）和一次性买断（€247）解锁完整功能。当前MRR $362，近30天营收$2,309
...
法国开发者Seven，2025年10月创立

## 这个案例能学到什么

展示如何在小众垂直领域（跑步训练）通过AI实现服务标准化，验证了专业场景下轻量级SaaS的可行性。定价策略兼顾持续收入和现金流平衡

## 来源与数据

- TrustMRR 原始页：`https://trustmrr.com/startup/7running`
- 营收由 Stripe API 验证，非自报；最后同步 2026-09-15T09:28:06.078Z。
- 官网：`https://7running.coach/`

## 一句话总结

> 用AI动态生成跑步训练计划的微型SaaS，12个月累计营收$4,900
