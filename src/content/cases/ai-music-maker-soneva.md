...
# Ai Music Maker - Soneva：Soneva是一款iOS端AI音乐生成应用，提供50种预设风格和歌词教育功能，上线三个月累计营收1,162美元。

## 产品是什么

iOS端AI音乐生成器，含文本/歌词模式、50种音乐风格选择、人声定制及教育歌词生成功能，支持歌单创建与深度链接分享。

## 怎么赚的钱

免费用户每日限免生成次数，付费订阅（未披露价格）解锁无限生成，通过RevenueCat实现支付，累计营收1,162美元。

## 流量从哪来

未官方披露，推测主要来自App Store自然流量。官网DR评分为0，无社交媒体运营痕迹。
...
验证了AI+垂直场景（音乐创作）的可行性，但需注意：1) 单平台限制增长天花板 2) 无营销时MRR仅106美元 3) 当前挂牌出售状态反映可持续性挑战。

## 来源与数据

- TrustMRR 原始页：`https://trustmrr.com/startup/ai-music-maker-soneva`
- 营收由 RevenueCat API 验证，非自报；最后同步 2026-09-15T09:02:17.559Z。
- 官网：`https://sonevamusic.com/`

## 一句话总结

> 轻量级AI音乐工具通过订阅制实现自循环，但需突破平台单一性和增长瓶颈。
