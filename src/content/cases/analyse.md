...
# Analyse：是一个集网站分析、AI SEO 内容引擎和数据助手于一体的订阅制 SaaS 工具。

## 产品是什么

一站式增长分析平台，包含行为分析漏斗、用户留存队列跟踪、基于真实数据的AI内容生成，以及自然语言数据查询功能。支持WordPress/Ghost发布和Webhooks集成。

## 怎么赚的钱

SaaS订阅制，三档定价：Starter $29/月、Pro $89/月、Autopilot $249/月，当前MRR $494。
...
展示了如何通过AI增强传统分析工具的价值主张，将被动数据监控转化为主动的洞察与行动建议。其产品架构体现了当前SaaS领域'All-in-One'的集成趋势。

## 来源与数据

- TrustMRR 原始页：`https://trustmrr.com/startup/analyse`
- 营收由 Stripe API 验证，非自报；最后同步 2026-09-15T11:36:48.582Z。
- 官网：`https://analyse.net/`

## 一句话总结

> 通过AI驱动的工作流整合，将数据分析从观察工具转变为决策系统。
