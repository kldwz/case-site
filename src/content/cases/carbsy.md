...
# Carbsy：是一款通过拍照快速估算食物碳水化合物和营养成分的AI健康应用。

## 产品是什么

iOS应用，通过拍照识别食物中的碳水化合物、宏观营养素和升糖指数，主要服务于需要控制饮食的PCOS、生酮、糖尿病前期等人群。

## 怎么赚的钱

免费下载+应用内购买，提供周订阅（$3.99）、年订阅（$39.99）和终身买断（$39.99）三种付费方案。当前MRR为$259。
...
独立开发者Kirill Gusev（X账号粉丝39人）

## 这个案例能学到什么

展示如何用轻量级AI功能解决特定健康场景的高频需求，验证了即使在小众垂直领域，清晰的价值主张也能实现持续变现。但需注意当前用户基数较小（52个活跃订阅），产品处于早期验证阶段。

## 来源与数据

- TrustMRR 原始页：`https://trustmrr.com/startup/carbsy`
- 营收由 RevenueCat API 验证，非自报；最后同步 2026-09-15T09:20:22.845Z。
- 官网：`https://apps.apple.com/app/id6745561317`

## 一句话总结

> 瞄准饮食管理痛点的AI工具，验证了健康垂直领域订阅模式的可行性。
