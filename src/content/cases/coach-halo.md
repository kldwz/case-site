...
通过AI匹配系统连接教练与潜在客户的SaaS工具，提供线索筛选、触达和预约功能。

## 怎么赚的钱

按月订阅收费（$35/月），当前MRR为$205，主要收入来源为10个活跃订阅用户。

## 流量从哪来

未披露具体流量来源，域名评分(DR)较低（4.0），可能依赖定向行业推广或口碑传播。

## 站长是谁

创始人未披露，推测为熟悉教练行业或HR技术领域的独立开发者。

## 这个案例能学到什么

验证了在垂直领域（教练服务）用标准化SaaS解决非标服务获客问题的可行性，展示如何通过轻量级订阅模式快速启动。

## 来源与数据

- TrustMRR 原始页：`https://trustmrr.com/startup/coach-halo`
- 营收由 Stripe API 验证，非自报；最后同步 2026-09-16T21:19:19.227Z。
- 官网：`https://coach-halo.com/`

## 一句话总结

> 用订阅制SaaS解决教练行业获客痛点的早期验证项目。
