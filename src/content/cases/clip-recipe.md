...
# Clip Recipe：AI驱动的视频食谱提取工具，帮助用户从社交媒体视频中快速获取结构化食谱。

## 产品是什么

通过AI解析社交媒体烹饪视频，自动提取食材清单、步骤说明等结构化信息的SaaS工具。

## 怎么赚的钱

提供$3.29/月的订阅套餐和$149的终身买断选项，当前MRR$200，累计营收$10,772。

## 流量从哪来

未披露具体流量来源，域名评分(DR)7.0显示基础SEO建设。

## 站长是谁

葡萄牙开发者Francisco Macedo（X账号68粉丝），2024年10月上线。

## 这个案例能学到什么

验证了垂直场景AI工具的微付费可行性，混合定价模式可覆盖不同用户支付偏好。

## 来源与数据

- TrustMRR 原始页：`https://trustmrr.com/startup/clip-recipe`
- 营收由 Stripe API 验证，非自报；最后同步 2026-09-16T21:41:30.766Z。
- 官网：`https://cliprecipe.com/`

## 一句话总结

> 用AI解决烹饪视频回放痛点的轻量级工具，验证了内容结构化服务的市场需求。
