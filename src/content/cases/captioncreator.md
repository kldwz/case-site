...
# CaptionCreator：AI视频字幕生成工具，支持76种语言的转录与互译

## 产品是什么

基于AI的视频字幕生成平台，提供76种语言的转录和任意语言间翻译功能，支持字幕文件或纯文本导出

## 怎么赚的钱

采用积分订阅制，基础套餐10美元起购100积分，具体消耗规则未披露
...
印度开发者Vijayabhaskar J于2022年12月创建

## 这个案例能学到什么

展示了轻量级AI工具在细分场景的应用可能，但需注意该产品当前MRR为0美元，订阅用户清零，反映持续获客或留存存在挑战

## 来源与数据

- TrustMRR 原始页：`https://trustmrr.com/startup/captioncreator`
- 营收由 Paddle API 验证，非自报；最后同步 2026-09-15T12:07:24.225Z。
- 官网：`https://captioncreator.cc/`

## 一句话总结

> 多语言AI字幕工具验证了细分需求存在，但商业化可持续性待验证
