...
# ClaudeKit：提供基于 Claude Code 的多角色 AI 代理工具集，自动化开发与营销流程。

## 产品是什么

面向企业的生产级 AI 子代理系统，包含工程师套件（开发/测试/部署）和营销套件，支持现有技术栈。

## 怎么赚的钱

通过 $99/套件或 $149 组合包的订阅制 SaaS 模式，近12个月营收 $79,523。

## 流量从哪来

未披露具体渠道，域名 DR 45 显示有一定自然流量基础，创始人 X 账号有 3,207 粉丝。

## 站长是谁

越南开发者 Duy（/zuey/），2025年10月创立。

## 这个案例能学到什么

验证了细分场景 AI 工作流自动化的商业价值，但当前 $4 MRR 显示留存机制待优化。定价策略值得参考：基础功能拆分定价+场景捆绑溢价。

## 来源与数据

- TrustMRR 原始页：`https://trustmrr.com/startup/claudekit`
- 营收由 Polar API 验证，非自报；最后同步 2026-09-16T20:26:38.220Z。
- 官网：`https://claudekit.cc/`

## 一句话总结

> 模块化 AI 代理工具证明技术栈兼容性可作为差异化卖点，但需解决用户持续付费问题。
