...
iOS端AI音乐创作平台，支持通过文本提示生成原创歌曲/伴奏、AI人声翻唱（含特朗普等内置声线）、两曲混音及自动MV生成，采用生产级架构和简洁UI设计。

## 怎么赚的钱

订阅制为主：周订阅8.99美元，年订阅59.99美元，辅以应用内购买。当前月收入1,486美元，367个活跃订阅用户。

## 流量从哪来

未披露具体获客渠道，从App Store页面显示无社交媒体运营痕迹（X粉丝数为0）。
...
验证了轻量化AI音乐工具在移动端的商业化潜力，展示如何通过功能聚合（音乐+视频+混音）提升LTV。需注意其用户规模未披露，且近30天营收（847美元）较当前MRR出现波动。

## 来源与数据

- TrustMRR 原始页：`https://trustmrr.com/startup/ai-song-clip-generator`
- 营收由 RevenueCat API 验证，非自报；最后同步 2026-09-15T11:31:18.937Z。
- 官网：`https://apps.apple.com/app/ai-music-song-generator-tune/id6726998562`

## 一句话总结

> 功能聚合型AI音乐应用通过订阅制实现PMF，但增长稳定性待观察。
