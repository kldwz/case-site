...
基于 AI 的文件重命名工具，提供本地模式（一次性付费）和云端模式（按次计费）两种使用方式。

## 怎么赚的钱

通过一次性购买（Local Mode $19）和按使用量计费（Cloud Mode $10/200 credits）获得收入。近12个月营收$5,094。
...
土耳其开发者 Ozgur Ozer，X平台粉丝2,355人。

## 这个案例能学到什么

展示了如何将AI技术应用于解决文件管理这类具体问题，并通过灵活的定价策略（一次性+按需）实现商业化。产品目前挂牌出售中。

## 来源与数据

- TrustMRR 原始页：`https://trustmrr.com/startup/ai-renamer`
- 营收由 Polar API 验证，非自报；最后同步 2026-09-15T08:24:21.863Z。
- 官网：`https://airenamer.app/`

## 一句话总结

> 聚焦垂直场景的AI工具，采用混合定价验证了小额可持续收入模式。
