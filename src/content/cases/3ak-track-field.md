...
# 3AK Track & Field：是一款面向田径运动员的 AI 训练应用，通过个性化指导帮助用户提升表现。

## 产品是什么

为短跑/长跑运动员提供包含动作纠正、训练计划和表现分析的移动端AI教练工具，通过视频分析和个性化方案替代传统职业教练部分功能。

## 怎么赚的钱

应用内订阅制（年费$29.99-$39.99，月费$9.99，周费$6.99-$9.99），当前月经常性收入$11,804，累计营收$132,895。

## 流量从哪来

未官方披露，创始人Christian Rac的X账号有1,223名关注者。

## 站长是谁

Christian Rac，未披露其他背景信息。

## 这个案例能学到什么

验证了专业运动领域的数字化服务变现潜力，通过降低专业训练门槛（从职业运动员到业余爱好者）实现规模化订阅收入。

## 来源与数据

- TrustMRR 原始页：`https://trustmrr.com/startup/3ak-track-field`
- 营收由 RevenueCat API 验证，非自报；最后同步 2026-09-15T11:24:41.234Z。
- 官网：`https://apps.apple.com/app/id6756290066`

## 一句话总结

> 用AI技术将职业田径训练方案产品化，在细分运动领域实现年营收超13万美元的订阅模式验证。
